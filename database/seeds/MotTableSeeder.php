...
class MotTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Mot::create(['first_name' => 'Test Number','last_name' => 'Five','phone_number' => '01234 567890', 'email' => 'test5@freeserve.net', 'vehicle_make' => 'Renault Clio', 'vehicle_reg' => 'S293 HJV', 'comments'=>'', 'mot_date'=>'2014-10-02', 'expiry_date'=>'2015-10-18']);
        \App\Mot::create(['first_name' => 'Test Number','last_name' => 'Six','phone_number' => '01234 567890', 'email' => 'test6@googlemail.com', 'vehicle_make' => 'Citroen C2', 'vehicle_reg' => 'AD02 PYF', 'comments'=>'', 'mot_date'=>'2014-10-01', 'expiry_date'=>'2015-10-15']);
    }
}
